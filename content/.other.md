...
- 编程世界里，可变是万恶之源；而在现实业务建模里，可变对象 + 事件驱动
...
- 我们不能把各种不同的关注点混在一起，这是很多系统出问题的根源所在
  ...
  - 领域
    - Web
      ...
      - 后端
        - [NodeJS](./NodeJS)
        - [ ] RPC、TypeScript、BFF
          - [【第3047期】基于 RPC 和 TypeScript 的 BFF 设计与实践 ](https://mp.weixin.qq.com/s/b9rCxSsTFqCZ9HPEGSfU-w)
          - [JSON-RPC](https://mp.weixin.qq.com/s/WYpLRpafXEsrL4bXNRAZXA)
      - 音视频
        - [ ] 《从 0 打造音视频直播系统》
      - 可视化、3D、XR
      - 跨端
