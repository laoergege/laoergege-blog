<template>
  <article class="w-full prose prose-sm sm:prose-base lg:prose-lg pt-10" data-theme="cupcake">
    <content :page-key="$route.matched[0].name" />
    <vssue class="not-prose" :key="title" :title="title" :onBeforeOauth="onBeforeOauth" />
  </article>
</template>
